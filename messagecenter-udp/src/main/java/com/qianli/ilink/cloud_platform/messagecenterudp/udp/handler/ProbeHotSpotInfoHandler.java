...
@Component
public class ProbeHotSpotInfoHandler extends SimpleChannelInboundHandler<DatagramPacket> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, DatagramPacket msg){
        ...
        //System.out.println("热点数据被抛出================");
        messageSender.send(MessageType.PROBE_HOTSPOT_INFO.getValue(),content);
    }
